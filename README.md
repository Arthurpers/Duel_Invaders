Architecture visée : Nous avons deux machines, chacune a un client et un serveur. Le jeu tourne sur chaque machine et récupère les inputs de l'autre joueur grâce à un socket.
